...
<template>
  <v-container fluid>
    ...
    <!-- Student Cards Grid -->
    <v-card
      class="h-100 mb-3 pa-5"
      elevation="0"
      rounded="lg"
      hover
      :class="{ 'border-active': student.is_active }"
      v-for="student in filteredStudents"
      :key="student.user_table_id"
      v-if="filteredStudents.length > 0"
      variant="outlined"
      flat
    >
      <!-- <v-chip :color="student.profile_status === 'Completed' ? 'success' : 'warning'" size="small" variant="tonal" class="mb-3">
        ...
        <v-col cols="12" sm="6" md="4" lg="1">
          <div class="text-center">
            <!-- <v-avatar size="100" color="primary">
              <span class="text-h6">{{ student.name.charAt(0).toUpperCase() }}</span>
            </v-avatar> -->
          </div>
        </v-col>
        <v-col cols="12" sm="6" md="4" lg="2">
          <div class="text-center">
            <div class="mt-2">
              ...
              <p class="text-body-2 text-medium-emphasis">{{ student.student_id }}</p>
              <div class="text-body-2 ms-6">{{ student.signup_date }}</div>
            </div>
          </div>
        </v-col>
        <v-col cols="12" sm="6" md="4" lg="2">
          ...
          <div class="detail-item mb-2">
            <div class="d-flex align-center mb-1">
              <v-icon size="16" class="me-2 text-primary">mdi-school</v-icon>
              <span class="text-caption text-medium-emphasis">Class & Board</span>
            </div>
            <div class="text-body-2 ms-6">
              {{ student.class_name }} - {{ student.education_board }}
            </div>
          </div>
          ...
          <div class="detail-item mb-2">
            <div class="d-flex align-center mb-1">
              <v-icon size="16" class="me-2 text-primary">mdi-map-marker</v-icon>
              <span class="text-caption text-medium-emphasis">Location</span>
            </div>
            <div class="text-body-2 ms-6">{{ student.city }}, {{ student.state }}</div>
          </div>
        </v-col>
        <v-col cols="12" sm="6" md="4" lg="2">
          <!-- Contact -->
          <div class="detail-item mb-2">
            <div class="d-flex align-center mb-1">
              <v-icon size="16" class="me-2 text-primary">mdi-phone</v-icon>
              <span class="text-caption text-medium-emphasis">Contact</span>
            </div>
            <div class="text-body-2 ms-6">{{ student.mobile }}</div>
          </div>

          <!-- Email -->
          <div class="detail-item mb-2">
            <div class="d-flex align-center mb-1">
              <v-icon size="16" class="me-2 text-primary">mdi-email</v-icon>
              <span class="text-caption text-medium-emphasis">Email</span>
            </div>
            <div class="text-body-2 ms-6 text-truncate">{{ student.email }}</div>
          </div>
        </v-col>
        <v-col cols="12" sm="6" md="4" lg="2">
          <!-- Signup Date -->
          <div class="detail-item">
            <div class="d-flex align-center mb-1">
              <v-icon size="16" class="me-2 text-primary">mdi-calendar</v-icon>
              <span class="text-caption text-medium-emphasis">Signup Date</span>
            </div>
            <div class="text-body-2 ms-6">{{ student.signup_date }}</div>
          </div>
        </v-col>
    ...
    <v-row v-else>
      <v-col cols="12">
        <v-card class="text-center pa-8" elevation="0" variant="outlined">
          ...
          <v-btn v-if="!searchQuery" color="primary" prepend-icon="mdi-plus">
            Add New Student
          </v-btn>
        </v-card>
      </v-col>
