...
const studentListConfig: Record<string, any> = {
  ...
  [$keys.ACCOUNT_STUDENT]: {
    ...
    dataTableConfig: {
      headers: [
        { title: 'Session ID', key: 'student_id', minWidth: '65px', sortable: false },
        { title: 'Tutor Info', key: 'user', minWidth: '100px', align: 'start', formatType: $keys.DT_PROFILE, sortable: false },
        { title: 'Date & Time', key: 'signup_date', sortable: false },
        { title: 'Duration', key: 'DURATION', align: 'start', formatType: $keys.DT_CUSTOM, sortable: false },
        { title: 'Actions', key: 'DT_BTNS', align: 'end', formatType: $keys.DT_CUSTOM, sortable: false }
      ]
    },
    profileCardConfig: [
